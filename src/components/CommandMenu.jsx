...
const CommandMenu = () => {
  ...
  return (
    <>
      {/* Command menu button */}
      <button 
        className="fixed print:hidden bottom-5 cursor-pointer md:right-40 right-2 p-2 bg-white rounded-full border-[1px] border-black/20 shadow-lg hover:shadow-xl transition-shadow z-40"
        onClick={toggleMenu}
