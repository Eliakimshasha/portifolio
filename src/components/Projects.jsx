  ...
  const projects = [
    {
      ...
      description:
        "Your partner in health. A platform that provides tailored wellness plans, expert advice, and holistic care solutions.",
    ...
    },
    {
      ...
      title: "Bonsai Works",
      description:
        "A mining company in Tanzania specializing in sustainable mineral extraction and resource management.",
   ...
   
    {
      ...
      title: "Hade Stays",
      description:
        "A comprehensive accommodation booking platform specializing in East African destinations, offering stays and co-working spaces across Tanzania, Kenya, and South Africa with integrated tour packages.",
      technologies: ["Next.js", "React", "Express.js", "Tailwind CSS"],
      clientProject: true,
   ...
   
    {
      ...
      description:
        "A logistics company offering freight, warehousing, and supply chain solutions across Tanzania.",
              ...
              <div className="p-5">
                <div className="flex items-center justify-between">
                  ...
                  {project.clientProject ? (
                    <div className="text-[10px] bg-gray-100 text-gray-900 px-2 py-1 rounded">
                      Client Project
                    </div>
                  ) : (
                    <div className="text-[10px] bg-gray-100 text-gray-900 px-2 py-1 rounded">
